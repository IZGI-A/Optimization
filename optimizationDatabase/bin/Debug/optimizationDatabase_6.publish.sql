...
GO
ALTER TABLE [dbo].[Employees] ALTER COLUMN [Password] VARCHAR (40) NOT NULL;
...
GO
ALTER TABLE [dbo].[LoginFailures] WITH NOCHECK
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.LoginFailures'))
               AND [type] IN (N'F', N'C')
